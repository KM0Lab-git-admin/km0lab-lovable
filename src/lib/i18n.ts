...
const D = {
 ...
 "profile.birth_date_hint": { ca: "Rebràs 500 punts pel teu aniversari 🎂", es: "Recibirás 500 puntos por tu cumpleaños 🎂", en: "You'll get 500 points on your birthday 🎂" } as Dict,
  ...
  "invites.compact.person.one": { ca: "{count} persona", es: "{count} persona", en: "{count} person" } as Dict,
  "invites.compact.person.other": { ca: "{count} persones", es: "{count} personas", en: "{count} people" } as Dict,
