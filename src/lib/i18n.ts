...
const D = {
 ...
 "profile.birth_date_hint": { ca: "Rebràs 500 punts pel teu aniversari 🎂", es: "Recibirás 500 puntos por tu cumpleaños 🎂", en: "You'll get 500 points on your birthday 🎂" } as Dict,
  ...
  "invites.empty.description": { ca: "Comparteix el teu enllaç. Aquí veuràs els registres que es vinculin a tu.", es: "Comparte tu enlace. Aquí verás los registros que se vinculen a ti.", en: "Share your link. Registrations linked to you will appear here." } as Dict,
