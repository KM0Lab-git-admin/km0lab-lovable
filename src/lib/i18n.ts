...
const D = {
 ...
 "profile.birth_date_hint": { ca: "Rebràs 500 punts pel teu aniversari 🎂", es: "Recibirás 500 puntos por tu cumpleaños 🎂", en: "You'll get 500 points on your birthday 🎂" } as Dict,
  ...
  "invite.home.note": { ca: "Guanyes punts quan completen el registre", es: "Ganas puntos cuando completan su registro", en: "You earn points when they complete registration" } as Dict,
