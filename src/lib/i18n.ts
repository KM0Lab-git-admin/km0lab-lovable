...
const D = {
 ...
 "profile.birth_date_hint": { ca: "Rebràs 500 punts pel teu aniversari 🎂", es: "Recibirás 500 puntos por tu cumpleaños 🎂", en: "You'll get 500 points on your birthday 🎂" } as Dict,
  ...
  "invite.share.cta": { ca: "Comparteix la invitació", es: "Compartir invitación", en: "Share invitation" } as Dict,
  "invite.share.copy": { ca: "Copiar enllaç", es: "Copiar enlace", en: "Copy link" } as Dict,
  "invite.share.qr": { ca: "Mostrar QR", es: "Mostrar QR", en: "Show QR" } as Dict,
  ...
  "invite.qr.title": { ca: "Escaneja per registrar-te", es: "Escanea para registrarte", en: "Scan to register" } as Dict,
  "invite.qr.description": { ca: "Aquest QR és una invitació, no el QR de visites dels comerços.", es: "Este QR es una invitación, no el QR de visitas de los comercios.", en: "This is an invitation QR, not a shop visit QR." } as Dict,
  "invite.auth.title": { ca: "Inicia sessió per convidar", es: "Inicia sesión para invitar", en: "Sign in to invite" } as Dict,
  ...
  "share.qr": { ca: "Mostra el QR", es: "Mostrar QR", en: "Show QR" } as Dict,
  ...
  "share.public_text": { ca: "Descobreix els comerços, serveis i activitats del teu municipi a KM0 Lab: {link}", es: "Descubre los comercios, servicios y actividades de tu municipio en KM0 Lab: {link}", en: "Discover the shops, services and activities in your town on KM0 Lab: {link}" } as Dict,
  "share.qr.title": { ca: "Escaneja per descobrir KM0 Lab", es: "Escanea para descubrir KM0 Lab", en: "Scan to discover KM0 Lab" } as Dict,
