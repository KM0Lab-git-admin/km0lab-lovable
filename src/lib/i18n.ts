...
const D = {
 ...
 "profile.birth_date_hint": { ca: "Rebràs 500 punts pel teu aniversari 🎂", es: "Recibirás 500 puntos por tu cumpleaños 🎂", en: "You'll get 500 points on your birthday 🎂" } as Dict,
  ...
  "invite.explain.person": { ca: "Guanyaras 100 punts quan una persona nova completi el registre amb la teva invitacio", es: "Ganaras 100 puntos cuando una persona nueva complete el registro con tu invitacion", en: "You will earn 100 points when a new person completes registration with your invitation" } as Dict,
  "invite.explain.business": { ca: "Guanyaras 500 punts quan un negoci nou completi el formulari d\u2019alta amb la teva invitacio", es: "Ganaras 500 puntos cuando un negocio nuevo complete el formulario de alta con tu invitacion", en: "You will earn 500 points when a new business completes the registration form with your invitation" } as Dict,
  "invite.channels.title": { ca: "Com vols enviar la invitacio?", es: "\u00bfComo quieres enviar la invitacion?", en: "How do you want to send the invitation?" } as Dict,
  "invite.session.expired.title": { ca: "La teva sessio ha caducat", es: "Tu sesion ha caducado", en: "Your session has expired" } as Dict,
  "invite.session.expired.description": { ca: "Recupera la sessio per generar invitacions amb punts.", es: "Recupera la sesion para generar invitaciones con puntos.", en: "Restore your session to create invitations with points." } as Dict,
  "share.panel.notice": {
